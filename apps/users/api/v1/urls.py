...
from .views import UserProfileView, UserDetailView, FollowUserAPIView, FollowerList, FollowingList, UserSearchAPIView, SearchResultsAPIView
...
urlpatterns = [
    ...
    path('searchResults/', SearchResultsAPIView.as_view(), name="search_results"),
]